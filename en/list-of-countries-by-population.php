...
?>
	...
	<title>List of countries by population <?php echo $year?></title>
	<meta name="description" content="List of all countries by population in <?php echo $year?>.">
	<meta name="keywords" content="List of countries by population">
	
	<link rel="shortcut icon" href="https://all-populations.com/favicon.ico" type="image/x-icon">

	<link rel="canonical" href="https://all-populations.com/en/list-of-countries-by-population.html">

	<link rel="alternate" href="https://all-populations.com/en/list-of-countries-by-population.html" hreflang="en">
	<link rel="alternate" href="https://all-populations.com/ru/list-of-countries-by-population.html" hreflang="ru">
	...
	<base href="https://all-populations.com/en/list-of-countries-by-population.html">
<?php
echo $headtop;
?>
  </head>
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-left">
            <li class="active" itemprop="name"><a itemprop="url" href="https://all-populations.com/en/list-of-countries-by-population.html">Countries</a></li>
			...
			<div id="breadcrumbs">
				<div id="breadcrumbs-inner">
					<ul itemscope="" itemtype="http://schema.org/BreadcrumbList">
						...
						<li itemscope="" itemprop="itemListElement" itemtype="http://schema.org/ListItem">
							<span itemprop="item">
								<span itemprop="name">List of cuntries by population</span>
							</span>
						</li>      
					</ul>
				</div>
		...
		<div class="row">
			...
			<section class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
				<div class="panel-heading">
					<h1 itemprop="headline">List of all countries by population</h1>
				</div>
				
				<div itemprop="text">
					<p>List of 194 countries by population in <?php echo $year;?>.</p>
				</div>	
				  ...
				  <table class="table table-bordered">
					...
					<tbody id="myTable">
					  <?php getTableAllCountryEn($libcountry,1);?>
					</tbody>
				  </table>
				  </div>
				...
				<ul class="parent-menu-list">
					<li>
						...
						<ul class="language-menu-list">
							<li>
								<a href="https://all-populations.com/ru/list-of-countries-by-population.html" title="Список стран по населению">
