      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-left">
            <li class="active" itemprop="name"><a itemprop="url" href="list-of-countries-by-population.php">Countries</a></li>
				...
				<ul class="parent-menu-list">
					<li>
						...
						<ul class="language-menu-list">
							<li>
								<a href="../ru/list-of-countries-by-population.php" title="Список стран по населению">
