...
?>
	...
	<title>List of republics by population <?php echo $year?></title>
	<meta name="description" content="List of all republics by population <?php echo $year?>.">
	<meta name="keywords" content="List of republics by population ">
	
	<link rel="shortcut icon" href="https://all-populations.com/favicon.ico" type="image/x-icon">

	<link rel="canonical" href="https://all-populations.com/en/list-of-republics-by-population.html">

	<link rel="alternate" href="https://all-populations.com/en/list-of-republics-by-population.html" hreflang="en">
	<link rel="alternate" href="https://all-populations.com/ru/list-of-republics-by-population.html" hreflang="ru">
	...
	<base href="https://all-populations.com/en/list-of-republics-by-population.html">
<?php
echo $headtop;
?>
  </head>
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-left">
            ...
            <li class="active" itemprop="name"><a itemprop="url" href="https://all-populations.com/en/list-of-republics-by-population.html">Republics</a></li>
					...
					<ul itemscope="" itemtype="http://schema.org/BreadcrumbList">
						<li itemscope="" itemprop="itemListElement" itemtype="http://schema.org/ListItem">
							<a href="https://all-populations.com/en/population-of-earth.html" itemprop="item">
								<span itemprop="name">Population if Earth</span>
							</a>
						</li>    
						<li itemscope="" itemprop="itemListElement" itemtype="http://schema.org/ListItem">
							<span itemprop="item">
								<span itemprop="name">List of republics by population</span>
							</span>
						</li>      
					</ul>
				</div>
		...
		<div class="row">
			...
			<section class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
				<div class="panel-heading">
					<h1 itemprop="headline">List of all republics by population</h1>
				</div>
				
				<div itemprop="text">
					<p>List of 121 republics by population in <?php echo $year;?>.</p>
				</div>	
				  <input class="form-control" id="myInput" type="text" placeholder="Search republic..">
				  <br>
				  ...
				  <table class="table table-bordered">
					...
					<tbody id="myTable">
					  <?php getTableAllRepublicEn($librepublic,1);?>
					</tbody>
				  </table>
				  </div>
				...
				<ul class="parent-menu-list">
					<li>
						...
						<ul class="language-menu-list">
							<li>
								<a href="https://all-populations.com/ru/list-of-republics-by-population.html" title="Список республик по населению">
									Список республик по населению
								</a>
							</li>
						</ul>
					</li>
