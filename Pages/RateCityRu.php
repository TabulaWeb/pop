	...
	<div class='container'>
		...
		<div class='row'>
			...
			<section class='col-xs-12 col-sm-12 col-md-8 col-lg-8'>
				...
				if (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/ru/list-of-cities-in-russia-by-population.html"){
				...
				} elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/cn/list-of-cities-in-china-by-population.html"){
				...
				} elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/fr/list-of-cities-in-france-by-population.html") {
				...
				} elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/de/list-of-cities-in-germany-by-population.html"){
					?>
					...
					<?php
				} elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/jp/list-of-cities-in-japan-by-population.html"){
					?>
					...
					<?php
				} elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/tr/list-of-cities-in-turkey-by-population.html"){
					?>
					...
					<?php
				} elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/it/list-of-cities-in-italy-by-population.html") {
					?>
					...
					<?php
				} elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/br/list-of-cities-in-brazil-by-population.html"){
					?>
					...
					<?php
				} elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/in/list-of-cities-in-india-by-population.html") {
					?>
					...
					<?php
				} elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/us/list-of-cities-in-usa-by-population.html"){
					?>
