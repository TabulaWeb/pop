    <div class='container'>
           ...
           <div class='row'>
               ...
               <section class='col-xs-12 col-sm-12 col-md-8 col-lg-8'>
                   ...
                   <p>
                   <?php
                       if (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/ru/population-of-russia.html"){
                           print("На 2020 год численность населения");
                       } elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/cn/population-of-china.html"){
                           print("На 2020 год численность населения");
                       } elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/jp/population-of-japan.html"){
                           print("На 2020 год численность населения");
                       } elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/de/population-of-germany.html"){
                           print("На 2020 год численность населения");
                       } elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/in/population-of-india.html"){
                           print("На 2020 год численность населения");
                       } elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/tr/population-of-turkey.html"){
                           print("На 2020 год численность населения");
                       } elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/fr/population-of-france.html"){
                           print("На 2020 год численность населения");
                       } elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/us/population-of-usa.html"){
                           print("На 2020 год численность населения");
                       } elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/it/population-of-italy.html"){
                           print("На 2020 год численность населения");
                       } elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/br/population-of-brazil.html"){
                           print("На 2020 год численность населения");
                       } else {
                           print("На 2020 год численность населения");
                       }
