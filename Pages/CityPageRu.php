			...
			<section class='col-xs-12 col-sm-12 col-md-8 col-lg-8'>
				<div class='panel-heading' >
					...
					<div  itemprop='text'>	
						<p>
						<?php
						if (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/jp/population-of-tokyo.html"){
							print("На 2020 год численность населения города");
						} elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/cn/population-of-shanghai.html"){
							print("На 2020 год численность населения города");
						} elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/tr/population-of-istanbul.html"){
							print("На 2020 год численность населения города");
						} elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/cn/population-of-hong-kong.html"){
							print("На 2020 год численность населения города");
						} elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/ru/population-of-moscow.html"){
							print("На 2020 год численность населения города");
						} else {
							print("На 2020 год численность населения города");
						}
						...
						if (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/jp/population-of-tokyo.html" ){
							...
							print("Наш сайт использовал данные количества населения из официальных источников.");
						} elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/eng/population-of-london.html") {
							print("");
						} elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/cn/population-of-beijing.html") {
							print("");
						} elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/cn/population-of-hong-kong.html"){
							print("Наш сайт использовал данные количества населения из официальных источников.");
						} elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/ru/population-of-moscow.html"){
				...
				} elseif (ltrim(urldecode($_SERVER['REQUEST_URI']), "/") == "ru/ru/population-of-saint-petersburg.html"){
