...
?>
	...
	<title>Список королевств по населению <?php echo $year?></title>
	<meta name="description" content="Список всех королевств по численности населения на <?php echo $year?>.">
	<meta name="keywords" content="Список королевств по населению">
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-left">
            ...
            <li class="active" itemprop="name"><a itemprop="url" href="list-of-kingdoms-by-population.php">Королевства</a></li>
			...
			<div id="breadcrumbs">
				<div id="breadcrumbs-inner">
					<ul itemscope="" itemtype="http://schema.org/BreadcrumbList">
						...
						<li itemscope="" itemprop="itemListElement" itemtype="http://schema.org/ListItem">
							<span itemprop="item">
								<span itemprop="name">Список королевств по населению</span>
							</span>
						</li>      
					</ul>
				</div>
		...
		<div class="row">
			...
			<section class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
				<div class="panel-heading">
					<h1 itemprop="headline">Список всех королевств по численности населения</h1>
				</div>
				
				<div itemprop="text">
					<p>Список из 15 королевст по численности населения на <?php echo $year;?> год.</p>
				</div>	
				  <input class="form-control" id="myInput" type="text" placeholder="Поиск королевства..">
				  <br>
				  ...
				  <table class="table table-bordered">
					...
					<tbody id="myTable">
					  <?php getTableAllKingdomRu($libkingdom,1);?>
					</tbody>
				  </table>
				  </div>
				...
				<ul class="parent-menu-list">
					<li>
						...
						<ul class="language-menu-list">
							<li>
								<a href="https://all-populations.com/en/list-of-kingdoms-by-population.html" title="List of kingdoms by population">
									List of kingdoms by population
								</a>
							</li>
						</ul>
					</li>
